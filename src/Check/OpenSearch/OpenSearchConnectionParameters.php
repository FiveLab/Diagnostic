...
/**
 * The model for store parameters for connect to OpenSearch.
 */
class OpenSearchConnectionParameters
{
    /**
     * @var string
     */
    ...
    /**
     * Get the host for connect to OpenSearch
     *
     * @return string
     */
    ...
    /**
     * Get the port for connect to OpenSearch
     *
     * @return int
     */
    ...
    /**
     * Get the username for connect to OpenSearch
     *
     * @return string
     */
